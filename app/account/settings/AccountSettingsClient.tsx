            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between py-2">
                ...
                <Switch
                  ...
                  checked={emailPreferences.transactionalEmailsEnabled}
                  onCheckedChange={() => handleTogglePreference('transactionalEmailsEnabled')}
                />
              </div>
              ...
              <div className="flex items-center justify-between py-2">
                <div className="space-y-0.5">
                  ...
                  <p className="font-body text-xs text-muted-foreground">
                    Get text updates for important order changes
                  </p>
                </div>
                <Switch
                  id="toggle-shipping-updates"
                  checked={emailPreferences.smsNotificationsEnabled}
                  onCheckedChange={() => handleTogglePreference('smsNotificationsEnabled')}
                />
              </div>
