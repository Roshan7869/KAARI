...
// WhatsApp floating action button — renders fixed bottom-right globally
// Include in root layout (outside <main>) so it appears on every page

interface WhatsAppFloatProps {
  /** WhatsApp number including country code, no +, no spaces. e.g. "919876543210" */
  phoneNumber?: string;
  /** Pre-filled message */
  message?: string;
}
  ...
  return (
    <>
      ...
      <a
        ...
        className="wa-float-btn fixed bottom-5 right-5 z-[500] w-14 h-14 rounded-full flex items-center justify-center"
