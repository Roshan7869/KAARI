...
export default function CustomDesignForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const sanitizedData = {
      ...
      email: sanitizeTextInput(formData.email, 255),
      designIdea: sanitizeTextInput(formData.designIdea, 1000),
    };

    // In a real implementation, this would send to an API
    // For now, we just show success after validation
    console.log('Custom design request:', sanitizedData);
